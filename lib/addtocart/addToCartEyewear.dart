...
class addToCartEye extends StatefulWidget {
  const addToCartEye({Key? key}) : super(key: key);

  @override
  _addToCartEyeState createState() => _addToCartEyeState();
}

// ignore: camel_case_types
class _addToCartEyeState extends State<addToCartEye> {
  @override
